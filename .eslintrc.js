 ...
 * @date        : 2023-03-22 14:50:23
 * @LastAuthor  : 池宗洋 chizongyang@mininglamp.com
 * @lastTime    : 2023-03-22 21:18:46
 * @FilePath    : /sentinel/.eslintrc.js
 */
...
module.exports = {
  ...
  rules: {
    ...
    "no-shadow": 2, //  禁止变量声明覆盖外层作用域的变量，例如arr.map((o) => o.find(o => o.name === 'zhangsan'))，两层循环都用到了o这个变量
    ...
    "@typescript-eslint/no-use-before-define": 1, // 使用之前需要先定义，先设置为警告，所有该问题修复后设置为error
    "@typescript-eslint/no-unused-expressions": 0, // 允许使用函数表达式
    "@typescript-eslint/no-unused-vars": 0,
    "@typescript-eslint/no-shadow": 1 // 禁止覆盖变量声明
  }
}
